 ...
 * rays emanating from the source. This parameter is the amount of light reduced
 * by passing through the tile. 0f or lower will block no light.
 *
 * If a simple radius is desired, set the resistance of your cells to 0f, the
 * force to 1f, and the decay to 1f / (the radius).
 *
