...
import com.nhydock.storymode.datatypes.quests.Quest.Actions;
import com.nhydock.storymode.datatypes.quests.Quest.QuestFactory;
...
public class QuestTracker implements Telegraph, Serializable {
    ...
    public QuestTracker() {
        ...
        MessageManager.getInstance().addListener(this, Actions.Gather);
        MessageManager.getInstance().addListener(this, Actions.Hunt);
        MessageManager.getInstance().addListener(this, Actions.Used);
    }
        ...
        for (int i = 0; i < quests.size;) {
            ...
            if (q.hasExpired()) {
                ...
                if (activeQuests.contains(q, true)) {
                    ...
                    MessageManager.getInstance().dispatchMessage(0, this, null, Actions.Expired, q);
                }
            }
            else {
                i++;
