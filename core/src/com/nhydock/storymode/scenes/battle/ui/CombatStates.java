    ...
    MAIN(){
        ...
        public boolean onMessage(final BattleUI entity, Telegram telegram) {
            if (telegram.message == Messages.Interface.Close){
                MessageManager.getInstance().dispatchMessage(null, entity.mainmenu.sm, CrossMenu.Messages.Prev);
                return true;
            }
            return false;
        }
        ...
        public void enter(final BattleUI entity) {
            final Runnable returnToState = new Runnable(){
                ...
                public void run() {
                    ...
                    MessageManager.getInstance().dispatchMessage(null, null, Messages.Battle.ADVANCE);
            ...
            if (telegram.message == Messages.Interface.Button) {
                ...
                if (entity.playerService.getInventory().sacrifice(entity.sacrificeList.getItems(), 1)){
                    ...
                    entity.playSacrificeAnimation(entity.boss, new Runnable() {
                        ...
                        @Override
                        public void run() {
                            MessageManager.getInstance().dispatchMessage(null, Messages.Battle.TARGET, entity.battleService.getBoss());
                            MessageManager.getInstance().dispatchMessage(null, Messages.Battle.MODIFY, adj);
                            MessageManager.getInstance().dispatchMessage(null, Messages.Battle.ADVANCE);
                            entity.changeState(MAIN);
                        }
                    });
                    return true;    
