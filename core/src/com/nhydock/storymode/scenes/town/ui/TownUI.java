...
import com.nhydock.scenes.scene2d.ui.ListKeyInput;
...
import com.nhydock.scenes.scene2d.ui.extras.ScrollFollower;
...
public class TownUI extends GameUI {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        if (stateMachine.isInState(TownState.Main)) {
                            MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Explore);
            ...
            homeImg.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        ...
                        if (stateMachine.isInState(TownState.Main)) {
                            MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Home);
                            audio.playSfx(DataDirs.Sounds.accept);
                        }
        ...
        // town icon
        {
            ...
            townImg.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        if (stateMachine.isInState(TownState.Main)) {
                            MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Town);
                            audio.playSfx(DataDirs.Sounds.accept);
                        }
                        return true;
                    }
    ...
    private void makeHome() {
        ...
        // sleep icon
        {
            ...
            sleepImg.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Sleep);
                        audio.playSfx(DataDirs.Sounds.accept);
                        return true;
                    }
                    return false;
        ...
        // save icon
        {
            ...
            saveImg.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Save);
                        audio.playSfx(DataDirs.Sounds.accept);
                        return true;
                    }
                    return false;
        ...
        //pagefile icon
        {
            ...
            dictImg.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.PageFile);
                        audio.playSfx(DataDirs.Sounds.accept);
                        return true;
                    }
                    return false;
    ...
    private void makeTown() {
        ...
        // Craft icon
        {
            ...
            craftImg.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Craft);
                        audio.playSfx(DataDirs.Sounds.accept);
                        return true;
                    }
                    return false;
        ...
        // quest icon
        {
            ...
            questImg.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Quest);
                        audio.playSfx(DataDirs.Sounds.accept);
                        return true;
                    }
                    return false;
        ...
        //train icon
        {
            ...
            trainImg.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Train);
                        audio.playSfx(DataDirs.Sounds.accept);
                        return true;
                    }
                    return false;
        ...
        craftMenu.setTabAction(new Runnable() {
            ...
            public void run() {
                ...
                if (craftMenu.getOpenTabIndex() == 0) {
                    MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Selected, craftList.getSelected());
                }
                else {
                    MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Selected, todayList.getSelected());
                }
            }
        ...
        craftMenu.addListener(new InputListener() {
            ...
            public boolean keyDown(InputEvent evt, int keycode) {
                ...
                if (Input.ACCEPT.match(keycode)) {
                    MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.Make);
                }
    ...
    private void makeQuest() {
        ...
        ButtonGroup<Button> questTabs = new ButtonGroup<Button>();
        {
            ...
            availableQuests.addListener(new ChangeListener() {
                ...
                public void changed(ChangeEvent event, Actor actor) {
                    ...
                    MessageManager.getInstance().dispatchMessage(0, ui, ui, Messages.Interface.Selected, q);
                }
            });
        }
        ...
        questMenu.addListener(new InputListener() {
            ...
            public boolean keyDown(InputEvent evt, int keycode) {
                ...
                if (Input.ACCEPT.match(keycode)){
                    MessageManager.getInstance().dispatchMessage(null, Messages.Interface.Button, Messages.Town.AcceptQuest);
                }
    ...
    private void makeSave() {
        ...
        for (int i = 1; i <= playerService.slots(); i++) {
            ...
            row.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    if (button == Buttons.LEFT) {
                        MessageManager.getInstance().dispatchMessage(0f, ui, ui, Messages.Interface.Selected,
    ...
    public void extend() {
        ...
        MessageManager.getInstance().addListener(this, Quest.Actions.Expired);
