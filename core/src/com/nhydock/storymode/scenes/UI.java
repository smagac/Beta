...
import com.nhydock.storymode.Storymode;
...
public abstract class UI extends Stage implements Telegraph {
    ...
    private final void deafen(){
        ...
        iter.reset();
        while (iter.hasNext) {
            MessageManager.getInstance().removeListener(this, iter.next());
        }
    }
            ...
            readme.addListener(new InputListener(){
                ...
                public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                    ...
                    if (getStateMachine().getGlobalState() != ReadmeState.instance) {
                        MessageManager.getInstance().dispatchMessage(null, Messages.Readme.Open);
                        return true;
                    } else {
                        MessageManager.getInstance().dispatchMessage(null, Messages.Readme.Close);
                        return true;
                    }
                }
                @Override
