...
import com.nhydock.scenes.scene2d.ui.extras.Pointer;
        ...
        // create load data dialog
        {
                ...
                button.addListener(new InputListener() {
                    ...
                    public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                        if (button == Buttons.LEFT) {
                            MessageManager.getInstance().dispatchMessage(null, ui, Messages.Interface.Selected, 0);
                            return true;
                        }
                        return false;
                    }
            ...
            for (int x = 0, i = 1; i <= 3; i++, x += 210) {
                ...
                card.addListener(new InputListener() {
                    ...
                    public boolean touchDown(InputEvent evt, float x, float y, int pointer, int button) {
                        if (button == Buttons.LEFT) {
                            MessageManager.getInstance().dispatchMessage(null, ui, Messages.Interface.Selected, index);
                            return true;
                        }
                        return false;
                    }
                ...
                new InputListener() {
                    ...
                    public boolean keyDown(InputEvent evt, int keycode) {
                        ...
                        if (Input.ACCEPT.match(keycode)) {
                            MessageManager.getInstance().dispatchMessage(null, ui, Messages.Interface.Selected, slotFocus.getFocusedIndex() + 1);
                            return true;
                        }
        ...
        //accept button
        {
            ...
            accept.addListener(new InputListener() {
                ...
                public boolean keyDown(InputEvent event, int keycode) {
                    if (Input.ACCEPT.match(keycode)) {
                        accept.setChecked(true);
                        MessageManager.getInstance().dispatchMessage(null, ui, Messages.Interface.Button);
                        return true;
                    }
                    return false;
                }
        ...
        textTable.addListener(new InputListener() {
            ...
            public boolean keyDown(InputEvent evt, int keycode) {
                if (Input.CANCEL.match(keycode)) {
                    MessageManager.getInstance().dispatchMessage(null, ui, Messages.Interface.Close);
                    return true;
                }
                if (Input.ACCEPT.match(keycode)) {
                    MessageManager.getInstance().dispatchMessage(null, ui, Messages.Interface.Notify);
                    return true;
                }
