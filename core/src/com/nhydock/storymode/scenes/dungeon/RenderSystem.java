...
import com.nhydock.storymode.datatypes.dungeon.Weather;
...
public class RenderSystem extends EntitySystem implements EntityListener, Telegraph {
    ...
    public void addedToEngine(Engine engine) {
        ...
        MessageManager.getInstance().addListener(this, Messages.Dungeon.Notify);
    }
    ...
    public void removedFromEngine(Engine engine) {
        ...
        MessageManager.getInstance().removeListener(this, Messages.Dungeon.Notify);
