...
public enum Direction {
    Up(0, 1, com.nhydock.storymode.common.Input.UP), 
    Down(0, -1, com.nhydock.storymode.common.Input.DOWN), 
    Left(-1, 0, com.nhydock.storymode.common.Input.LEFT), 
    Right(1, 0, com.nhydock.storymode.common.Input.RIGHT);

    private int[] move;
    private com.nhydock.storymode.common.Input keys;

    /**
     * @param key
     *            - Acceptable keys that mask to the direction
     */
    Direction(int x, int y, com.nhydock.storymode.common.Input key) {
        move = new int[]{x, y};
        keys = key;
    }
