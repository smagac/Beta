 ...
 * <p/>
 * Actors added to the focus group will switch focus when hovered over.  What this means
...
public class FocusGroup extends Actor{
	 ...
	 * @param a - reference to the actor in the group to remove
	 */
	...
	/**
	 * Removes a single actor from the group and unhooks its focus listener
	 * @param i - index of the actor in the group
	 */
	...
	/**
	 * Remove all actors from the group and removes all the focus listeners from those actors
	 */
	@Override
	public void clear()
	{
	...
	/**
	 * Focuses on the next actor in the list
	 * @param wrap - tells the focus group to wrap the index back to the beginning of the list if next is past the end
	 */
	...
	/**
	 * Focuses on the previous actor in the list
	 * @param wrap - tells the focus group to wrap the index back to the end of the list if prev is past the beginning
	 */
