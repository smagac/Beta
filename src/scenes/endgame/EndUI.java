...
public class EndUI extends UI {
    ...
    public void init() {
        ...
        goddess.addAction(Actions.sequence(
                ...
                Actions.forever(Actions.sequence(Actions.moveTo(getWidth() * .6f, 58f, 5f),
        ...
        fader.addAction(Actions.sequence(Actions.alpha(1f), Actions.alpha(0f, 8f)));
        addActor(fader);
        ...
        final TextButton done = new TextButton("DONE", skin);
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                stats.addAction(Actions.sequence(Actions.run(new Runnable() {
    ...
    private void showStats() {
        ...
        stats.addAction(Actions.sequence(Actions.alpha(0), Actions.alpha(1f, .2f)));
    ...
    private void end() {
        ...
        you.addAction(Actions.sequence(Actions.delay(5f),
                Actions.moveTo(getWidth() / 2f - you.getWidth() / 2f, 48f, 3f)));
        fader.addAction(Actions.sequence(Actions.delay(8f), Actions.alpha(1f, 3f)));
        addAction(Actions.sequence(Actions.delay(13f), Actions.alpha(0f), Actions.run(new Runnable() {
    ...
    private void advanceStory() {
        ...
        textTable.addAction(Actions.sequence(Actions.alpha(0f, .1f), Actions.run(new Runnable() {
