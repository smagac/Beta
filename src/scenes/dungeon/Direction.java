...
public enum Direction {
	...
	/**
	 * @param key - Acceptable keys that mask to the direction
	 */
	Direction(int... key)
	{
		keys = key;
	...
	/**
	 * Calculate a direction from the relative location of the mouse from the center of a viewport
	 * @param pos
	 * @param vw
	 * @param vh
	 * @return
	...
	/**
	 * Get a direction by checking the current key input from a GDX input instance
	 * @param input
	 * @return
	 */
