...
public interface IAudioManager extends Service {
	...
	/**
	 * Sets a new looping bgm for the manager to control, but does not initially start playing it
	 * @param bgm
	 */
	public void setBgm(Music bgm);
	
	/**
	 * Sets a new bgm for the manager to control, but does not initially start playing it
	 * @param bgm
	 ...
	 * @param bgm - bgm to set to be controlled by the manager
	 */
	 ...
	 * Plays a new bgm
	 * @param bgm
	 * @param loop - whether the song loops or not
	 */
