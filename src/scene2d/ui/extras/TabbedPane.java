...
/**
 * Simple widget for making stacked "panes" that can be switched between using tabs.
 * <p/>
 * Buttons defining tabs are passed into the pane.  Each button must have a pane assigned
 * to its user object in order to perform proper stack switching. 
 * @author nhydock
 *
 */
